-- =======================================================
-- CONFIGURACIÓN DE TAMAÑOS (MODIFICA AQUÍ EL ANCHO Y ALTO)
-- =======================================================
local CONFIG_TAMANO = {
    Loader_PC = {
        Ancho = 390,
...
local function k(l)if l or j()then return math.clamp(math.floor(i()*0.88),CONFIG_TAMANO.Loader_Movil.AnchoMin,CONFIG_TAMANO.Loader_Movil.AnchoMax)end return CONFIG_TAMANO.Loader_PC.Ancho end
local function m(l)if l or j()then return CONFIG_TAMANO.Loader_Movil.Alto end return CONFIG_TAMANO.Loader_PC.Alto end
...
_sC(_RunS.RenderStepped, function()
    if _FOVCircle then
        pcall(function()
            _FOVCircle.Visible = (_Cfg.ShowFOV and _Cfg.AimMode == "FOV")
...
sC(RunService.RenderStepped, function(dt)
    if FOVCircle then
        pcall(function()
            FOVCircle.Visible = (Config.ShowFOV and Config.AimMode == "FOV")
            FOVCircle.Radius = Config.AimFOV; FOVCircle.Position = Vector2.new(Camera.ViewportSize.X / 2, Camera.ViewportSize.Y / 2)
            FOVCircle.Color = State.lockedTarget and Config.Theme.FOVLocked or Config.Theme.FOVNormal
        end)
    end
end)
